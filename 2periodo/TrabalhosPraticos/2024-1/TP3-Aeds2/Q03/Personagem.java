...
class PilhaPersonagem {
     ...
     * function: empilhar
     * @params: Personagem
     * action: empilha o personagem na pilha
     */
    void empilhar(Personagem personagem) throws Exception {
        if (tamanho >= p.length) {
     ...
     * @params: Personagem
     * action: desempilha o personagem na pilha
     */
    ...
    /*
     * function: findPersonagem
     * @params: Personagem[] && String
     * action: Procura personagem no array e o retorna
     */
     ...
     * action: Chama os metodos empilhar e desempilhar de acordo com input
     */
    public void metodos(Personagem p[], int x) {
        ...
        for (int i = 0; i < x+1; i++) {
            ...
            try {
                if(str[0].equals("R")){
                    Personagem removido = desempilhar();
...
class Personagem {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PilhaPersonagem pilha = new PilhaPersonagem(404);
        ler(personagens, 1); // Segundo parametro: 0 para teste | 1 para enviar ao verde
        String id = pilha.sc.nextLine();
        while (!id.equals("FIM")) {
            Personagem novo = pilha.findPersonagem(personagens, id);
            pilha.empilhar(novo);
            id = pilha.sc.nextLine();
        }
        int qtd = pilha.sc.nextInt();
        pilha.metodos(personagens, qtd);
        pilha.sc.close();
    }
}