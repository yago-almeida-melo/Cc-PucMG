...
public class ArquivoTarefa extends Arquivo<Tarefa> {
    ...
    ListaInvertida indice_invertido;  // Índice invertido para acessar tarefas por palavra-chave
    ...
    public ArquivoTarefa() throws Exception {
        ...
        // Inicializa o índice invertido utilizando uma Lista Invertida
        indice_invertido = new ListaInvertida(4,"./BaseDeDados/dicionario.listainv.db", "./BaseDeDados/blocos.listainv.db");
    }
