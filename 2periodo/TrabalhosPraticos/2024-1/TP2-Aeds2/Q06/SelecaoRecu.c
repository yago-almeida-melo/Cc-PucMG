...
/*
    function: selecao
    @params: null
    action: Chama a função de ordenação, apenas para deixar mais organizado
*/
void selecao(){
    start = clock();
    selecaoArray(0);
...
/*
    function: selecaoArray
    @params: int
    action: Ordenada o subArray pelo metodo de seleção, usando recursão
*/
void selecaoArray(int index){
