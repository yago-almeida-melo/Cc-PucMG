 ...
 *  TP1-Q16: Ordenação por Inserção Parcial em Java
 */
 ...
 class Personagem{
    ...
    public static int dateComparator(Personagem d1, Personagem d2, Log log){
      ...
      */
    public static void insercaoParcial(Personagem personagens[], int n, int k,Log log){
        for (int i = 1; i < n; i++) {
    ...
    public static void main(String[] args) throws Exception{
        ...
        insercaoParcial(personagens, tam, 10, log);
