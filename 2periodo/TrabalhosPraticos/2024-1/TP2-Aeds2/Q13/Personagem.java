 ...
 */
 ...
 class Personagem{
    ...
    public static void swap(Personagem p[], int i, int j, Log log){
      ...
      * action: Chama a funcao para ordenar por mergesort
      */
     ...
     /*
      * function: mergesort
      * @params: Personagem[] && int && int && Log 
      * action: Ordena o Array de Personagem pelo atributo actorName e desempate por nome for igual
      */
    ...
    * action: Compara dois Personagens pelo actorName e se for igual, desempate por nome
    */
    ...
    /* 
    * function: intercalar
    * @params: Personagem[] && int && int && int && Log
    * action: Algoritmo que intercala os elementos entre as posicoes esq e dir
    */ 
   public static void intercalar(Personagem array[], int esq, int meio, int dir, Log log){
        ...
        while(i<n1 && j<n2){
            array[k] = (comparator(a1[i], a2[j], log)) ? a1[i++] : a2[j++];
            k++;
            log.incrementaMov();
        }
