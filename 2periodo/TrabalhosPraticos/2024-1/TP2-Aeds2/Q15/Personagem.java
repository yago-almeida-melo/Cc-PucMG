 ...
 *  TP1-Q15: Ordenação por Seleção Parcial em Java
 */
 ...
 class Personagem{
      ...
      */
     public static void selecaoParcial(Personagem personagens[], int n, int k,Log log){
         for (int i = 0; i < k; i++) {
			int menor = i;
			for (int j = (i + 1); j < n; j++){
     ...
     public static void main(String[] args) throws Exception{
         ...
         selecaoParcial(personagens, tam, 10, log);
